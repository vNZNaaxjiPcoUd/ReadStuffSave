...
圖6：主題叢集的文章架構。圖片來源：[hubspot](https://blog.hubspot.com/marketing/topic-clusters-seo)
...
- [Topic Clusters for SEO: What They Are & How to Create Them](https://www.semrush.com/blog/topic-clusters/)

延伸閱讀：

- [10 分鐘理解主題集群 Topic Cluster：SEO 經營策略的另一種視角](https://www.awoo.ai/zh-hant/blog/topic-cluster-seo/#Q2%EF%BC%9ATopic_Cluster_%E5%AE%B9%E6%98%93%E9%80%A0%E6%88%90%E7%AB%99%E5%85%A7%E7%AB%B6%E7%88%AD%E5%97%8E%EF%BC%9F)
...
但是對於有一些人來說，精選摘要的出現可能會導致網站點擊次數下降，有[研究](https://www.semrush.com/blog/zero-clicks-study/)指出，將近57%的手機搜尋者和25%桌機搜尋者在看完精選摘要版位後，就選擇直接離開網站，而這些人通常是因為搜尋了一些關於公共資訊、名人資料等內容，因此在獲得答案後，就不需要再進一步網站互動。但這代表就網站經營者就需要放棄這些點擊數嗎？當然不是，反而可以進一步思考如何獲取這些可以產生精選摘要的關鍵字，才有機會增加品牌曝光。試想如果未來SGE的時代來臨，如果網站內容沒有受到SGE的青睞，那麼精選摘要就是你另一個最好的選擇(但還不確定精選摘要和SGE之間是否會同步出現)。
...
![](https://media.awoo.ai/live/wp-content/uploads/10032198_17202781-%E8%BD%89%E6%8F%9B-min.jpeg)
...
身為行銷人員的你，總是為了流量而苦惱，找不到消費者在哪裡？消費者不是不見，只是你沒有發現！根據 Digital 2023 Taiwan 資料，台灣網路使用者高達 2,168 萬人，每天上網時間超過 7 小時，潛力消費者活生生的存在於網路上。還說找不到客戶嗎？以下四招，把網路上的消費者，變成網站流量，也變成穩定客源！

目錄

[](https://www.awoo.ai/zh-hant/blog/source-of-customer/#)

- [客源的行為本質：行銷漏斗](https://www.awoo.ai/zh-hant/blog/source-of-customer/#%E5%AE%A2%E6%BA%90%E7%9A%84%E8%A1%8C%E7%82%BA%E6%9C%AC%E8%B3%AA%EF%BC%9A%E8%A1%8C%E9%8A%B7%E6%BC%8F%E6%96%97 "客源的行為本質：行銷漏斗")
- [B2B 客源：善用 SEO 與 email](https://www.awoo.ai/zh-hant/blog/source-of-customer/#B2B_%E5%AE%A2%E6%BA%90%EF%BC%9A%E5%96%84%E7%94%A8_SEO_%E8%88%87_email "B2B 客源：善用 SEO 與 email")
- [B2C 客源：掌握網紅與廣告投放](https://www.awoo.ai/zh-hant/blog/source-of-customer/#B2C_%E5%AE%A2%E6%BA%90%EF%BC%9A%E6%8E%8C%E6%8F%A1%E7%B6%B2%E7%B4%85%E8%88%87%E5%BB%A3%E5%91%8A%E6%8A%95%E6%94%BE "B2C 客源：掌握網紅與廣告投放")
- [Cookieless 救星： AI 商品數據驅動廣告，獲取好流量](https://www.awoo.ai/zh-hant/blog/source-of-customer/#Cookieless_%E6%95%91%E6%98%9F%EF%BC%9A_AI_%E5%95%86%E5%93%81%E6%95%B8%E6%93%9A%E9%A9%85%E5%8B%95%E5%BB%A3%E5%91%8A%EF%BC%8C%E7%8D%B2%E5%8F%96%E5%A5%BD%E6%B5%81%E9%87%8F "Cookieless 救星： AI 商品數據驅動廣告，獲取好流量")

## **客源的行為本質：行銷漏斗**

傳統行銷漏斗（曝光、發現、思考、轉換、顧客關係、顧客回訪），運用大量有效的曝光來讓消費者看見商品，發現商品有機會滿足自己的購買意圖，進而思考評估，最後決定購買，帶來轉換，若問哪個階段最為關鍵，恐怕多數的人都認為是「曝光」，對照後來以「網路行為」為基礎的 AISAS 行為模式（Attention、Interest、Search、Action、Share、Retargeting），或是行銷教父菲利普柯特勒的 5A 顧客體驗（Aware、Appeal、Ask、Act、Advocate），仍然是萬變不離其宗。

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20600%20300'%3E%3C/svg%3E)

「水龍頭：曝光」就是要讓潛在消費者「Attention 注意」並且「Aware 知道」你是誰、你賣什麼東西。然而，當我們對照「電商行銷」的三本柱：導流、導購、會員經營，卻會發現，導流不止於「曝光、Attention、Aware」，而是包含第二步的「發現、Interest、 Appeal」，並且進入第三步的「思考、Search、Ask」也就是評估階段，並且多數使用者會於此時進站檢閱商品資訊，也會上網搜尋開箱文、或是直接在社群上發問使用者經驗，也因而促成「內容行銷、KOL 體驗證言」應運而生，最後帶來轉換，消費者變成顧客、成為會員，而對於 2B 與 2C 的企業，又有各自的導流行銷手法。

## **B2B 客源：善用 SEO 與 email**

對於 B2B 的企業來說，由於客戶的需求通常相當明確，如需要雲端服務、租賃服務、設備採購、廣告置入等，需求端的經辦人員都是在接收「訪價、採買」指令，進而開始「上網搜尋找資訊」的動作，因此讓產品服務出現在 SERP （搜尋引擎結果頁）前列格外重要，以使用習慣而言， Google 提供資訊後，使用者通常都是點選前三個，所以 2B 企業的行銷人員，需要下苦心在 SEO 搜尋排名優化上，注意在圖文影音等內容上置入符合搜尋意圖的關鍵字，也需要優化網站架構／網頁的編碼與載入速度，提升用戶搜尋體驗。

延伸閱讀：[2024年 SEO 8大趨勢，瞄準生成式 AI 與 SGE，掌握流量成長的新未來](https://www.awoo.ai/zh-hant/blog/2024-seo-trends/)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201000%20563'%3E%3C/svg%3E)

此外，除了被動的讓買家來找你，email 行銷（又稱 EDM，Electronic Direct Mail）也是 B2B 常見的行銷手法，用來向品牌「維繫關係、推薦資訊、引導購買、延續服務」來提升顧客終生價值，也對提升品牌的會員忠誠度很有幫助。

## **B2C 客源：掌握網紅與廣告投放**

不同於 B2B 買家任務型質的需求意圖， B2C 消費者擁有剛性需求意圖時也會上網搜尋（最快的效率找到商品服務，此時內容文章、SEO、評論就大有作用），但平時大多可能是帶著「潛藏需求」在網路上瀏覽、追劇，或使用即時通聯繫親友、或看社群貼文、新聞資訊，此時 B2C 消費者處於被動狀態，行銷人員須要主動出擊去喚醒消費者內心的購物慾，而「網紅行銷」搭配「廣告投放」就是非常適合的行銷手法。

延伸閱讀：[Google 廣告投放必看懶人包！從入門觀念到實戰分析看這篇就夠](https://www.awoo.ai/zh-hant/blog/sem-dor-dummies/)

![](https://media.awoo.ai/live/wp-content/uploads/2150521919-min.jpeg)

比如 A 某下班滑社群時偶然看見「抗屑洗髮精」的廣告，想起自己好像是有這個問題需要改善，於是點選連結進入網站查看該商品細節，但因為跳到通訊軟體回訊息，或是想多比價等原因離開了網站，但在隔天又赫然在別的影音平台上，看見自己喜歡的網紅正好開箱那一款抗屑洗髮精的一周使用心得，於是點選了影片下的限時團購連結，看到免運優惠立刻就下單結帳。

像這樣透過廣告投放結合數據演算、篩選出類似特徵樣貌的消費者，正是當前火紅的電商行銷手法。然而，隱私權政策提升與第三方 Cookie 退場，使得廣告興趣受眾的設定越來越模糊化，若人的數據有了限制（第三方 Cookie），何不搭配「物的數據」（某商品被購買的意圖情境），並讓 AI 客觀陳述特徵條件，以此做為電商行銷的依據？

## **Cookieless 救星： AI 商品數據驅動廣告，獲取好流量**

「awoo AI  電商流量成長方案」運用 awoo PDP（awoo Product Discovery Platform）商品智慧探勘平台，以 AI 技術為商品萃取關鍵字，並以 awoo 累積超過十年 SEO 經驗的百億關鍵資料庫進行比對，自動生成契合消費者搜尋意圖的「AI 商品標籤」，再集結同類標籤大量生成利於搜尋引擎檢索的 awoo Page 商品主題集合頁，形同為電商網站開出眾多的進站入口，大幅增加商品被潛力買家看見的機會。

![](https://media.awoo.ai/live/wp-content/uploads/%E5%85%A7%E6%96%87%E5%9C%96%E7%89%87_5-1000x523.jpg)

此外，AI 商品標籤更能與 SEO 及廣告策略結合！在 SEO 方面，標籤互動資料能呈現消費者對於不同商品類別、風格、功能有興趣的程度，更可以比對銷售情形來洞察出隱藏在商品背後的商機，而這些關鍵字就可以拿來佈局內容行銷。在廣告方面，商品標籤與分類頁可以搭配 Google 與 Meta 廣告策略，利用分類頁的流量去做廣告自訂與相似受眾，或是將分類頁作為 Landing Page，更精準的投放能有效提升點擊率並優化轉換率，讓每一分進站流量都成為高價值流量。

在「電商營收公式 = 流量 x 轉換率 x 客單價」的鐵律公式下，現在的電商行銷手法無法只是一昧的把水龍頭開大、徒增成本，而是要找到正確的客源、不再盲目的亂槍打鳥，不僅讓網站流量持續增加，也能同步優化轉換率，透過 AI 商品標籤還能在消費者進站後給予符合意圖的商品推薦，刺激購買量增加客單價，縮短消費者在「行銷漏斗」中的搜尋過程、加速購買決策。
...
圖片在網站中地位是無可取代的，它們通常更容易吸引瀏覽者的目光，也能提高使用者瀏覽體驗，而搜尋結果中也經常出現醒目的圖片搜尋結果區塊，出現的圖片搜尋結果區塊往往更吸引人點擊，也為網站帶來更多的流量，因此針對網站圖片 SEO 也顯得格外重要。以下針對網站圖片提供五個圖片 SEO 步驟。

![圖片的搜尋結果區塊 (是不是讓人很想點擊呢？)](https://media.awoo.ai/live/wp-content/uploads/dog.png)

圖片的搜尋結果區塊 (是不是讓人很想點擊呢？)

目錄

[](https://www.awoo.ai/zh-hant/blog/images-optimization/#)

- [圖片SEO步驟一：選擇漂亮吸引人的圖片](https://www.awoo.ai/zh-hant/blog/images-optimization/#%E5%9C%96%E7%89%87SEO%E6%AD%A5%E9%A9%9F%E4%B8%80%EF%BC%9A%E9%81%B8%E6%93%87%E6%BC%82%E4%BA%AE%E5%90%B8%E5%BC%95%E4%BA%BA%E7%9A%84%E5%9C%96%E7%89%87 "圖片SEO步驟一：選擇漂亮吸引人的圖片")
- [圖片SEO步驟二：優化圖片檔案名稱](https://www.awoo.ai/zh-hant/blog/images-optimization/#%E5%9C%96%E7%89%87SEO%E6%AD%A5%E9%A9%9F%E4%BA%8C%EF%BC%9A%E5%84%AA%E5%8C%96%E5%9C%96%E7%89%87%E6%AA%94%E6%A1%88%E5%90%8D%E7%A8%B1 "圖片SEO步驟二：優化圖片檔案名稱")
- [圖片SEO步驟三：壓縮圖片檔案成適當大小](https://www.awoo.ai/zh-hant/blog/images-optimization/#%E5%9C%96%E7%89%87SEO%E6%AD%A5%E9%A9%9F%E4%B8%89%EF%BC%9A%E5%A3%93%E7%B8%AE%E5%9C%96%E7%89%87%E6%AA%94%E6%A1%88%E6%88%90%E9%81%A9%E7%95%B6%E5%A4%A7%E5%B0%8F "圖片SEO步驟三：壓縮圖片檔案成適當大小")
  - [圖片尺寸縮小為最適當的大小](https://www.awoo.ai/zh-hant/blog/images-optimization/#%E5%9C%96%E7%89%87%E5%B0%BA%E5%AF%B8%E7%B8%AE%E5%B0%8F%E7%82%BA%E6%9C%80%E9%81%A9%E7%95%B6%E7%9A%84%E5%A4%A7%E5%B0%8F "圖片尺寸縮小為最適當的大小")
  - [壓縮圖片大小](https://www.awoo.ai/zh-hant/blog/images-optimization/#%E5%A3%93%E7%B8%AE%E5%9C%96%E7%89%87%E5%A4%A7%E5%B0%8F "壓縮圖片大小")
- [圖片SEO步驟四：優化圖片的 Alt](https://www.awoo.ai/zh-hant/blog/images-optimization/#%E5%9C%96%E7%89%87SEO%E6%AD%A5%E9%A9%9F%E5%9B%9B%EF%BC%9A%E5%84%AA%E5%8C%96%E5%9C%96%E7%89%87%E7%9A%84_Alt "圖片SEO步驟四：優化圖片的 Alt")
- [圖片SEO步驟五：為圖片加上一段標題敘述](https://www.awoo.ai/zh-hant/blog/images-optimization/#%E5%9C%96%E7%89%87SEO%E6%AD%A5%E9%A9%9F%E4%BA%94%EF%BC%9A%E7%82%BA%E5%9C%96%E7%89%87%E5%8A%A0%E4%B8%8A%E4%B8%80%E6%AE%B5%E6%A8%99%E9%A1%8C%E6%95%98%E8%BF%B0 "圖片SEO步驟五：為圖片加上一段標題敘述")

## 圖片SEO步驟一：選擇漂亮吸引人的圖片

這時候你可能會有以下疑問：「搜尋引擎難不成是外貌協會的？還會選擇好看的圖片提升排名？」當然不是這樣，雖然漂亮的圖片不會讓你的網站排名突飛猛進，卻能為你的網站帶來更多點擊以及流量。  
想像一下當你的圖片與其他眾多茫茫大海圖片一起出現在搜尋結果中，瀏覽者第一個點擊的一定是最吸引人的圖片 (最吸引人的圖片類似是搜尋排名第一的概念)，也會為你的網站帶來更多的瀏覽訪客。

## 圖片SEO步驟二：優化圖片檔案名稱

很多的網站都會用無意義的圖片檔案名稱，例如：01.jpg、a1.png 等，這樣也許在圖片命名的時候很輕鬆愉快，只要照著編號一直列表下去即可，不過現在 Google 的搜尋引擎功能非常強大，雖然目前還無法讀取出圖片內的文字內容 (以後或許可以)，不過當搜尋引擎無法了解圖片內容時，將會參考周圍文字內容或是圖片檔案名稱作為圖片的搜尋結果。  
所以一個好的圖片檔案名稱建議應該使用具有相關意義的名稱，會讓搜尋引擎更了解圖片所代表的意義有所幫助。

## 圖片SEO步驟三：壓縮圖片檔案成適當大小

網站速度現在也是影響搜尋引擎排名的因素之一，而往往影響網站速度最大的原因就在於圖片的讀取，所以我們應該針對圖片做優化，以幫助我們提升網站瀏覽速度及使用者體驗。而通常一般會透過下列兩種方法優化圖片檔案大小：

### 圖片尺寸縮小為最適當的大小

網站常會有一種情況發生，例如網頁呈現圖片大小也許只要 200px * 200px，不過常常卻使用遠大於這個需求的圖片尺寸，而再使用CSS去縮小圖片，這樣也許是可以減少一道縮小圖片的動作，不過對於**網站讀取速度**卻是一種負荷。

### 壓縮圖片大小

將圖片在不失真和影響品質的情況下，壓縮至最小的檔案大小，可以到 [Google PageSpeed Insights](https://developers.google.com/speed/pagespeed/insights/?hl=zh-TW) 幫你測試網站速度分數  
它還會列表出網站頁面目前有哪些圖片需要做壓縮，並提供下載壓縮過的圖片。  
如果網站圖片是使用 Photoshop 軟體製作，建議在檔案存檔時 (儲存為網頁用)，就壓縮圖片到適合大小、品質。  
當然如果電腦沒有 Photoshop 的話，這邊也提供一些線上壓縮的網站連結：  
[https://tinypng.com](https://tinypng.com/)  
[https://compressor.io](https://compressor.io/)  
延伸閱讀：[網站速度優化，從Google Page Speed](https://www.awoo.com.tw/blog/google-page-speed-insights/) [Insights開始](https://www.awoo.com.tw/blog/google-page-speed-insights/)

## 圖片SEO步驟四：優化圖片的 Alt

Alt 對於圖片的優化是非常重要，圖片的 Alt 不只是圖片替代文字，更可以讓搜尋引擎在抓取圖片的時候了解圖片的主題內容。  
圖片 Alt 的設置並不應該推疊關鍵字，也不建議過長，應該針對圖片的代表意思來準確的撰寫 Alt，畢竟堆疊不相關的字就算使用者搜尋到也不會點擊不相關的內容，反而可能會被使用者檢舉，導致影響圖片收錄。  
圖片的Alt 在Html 中的使用方式為:

<img src="圖片網址" alt="圖片標題"/>

延伸閱讀：[做 SEO你絕對不可以忽略的【網站速度優化】，關於速度優化的三兩事](https://www.awoo.com.tw/blog/site-speed-optimization/)

## 圖片SEO步驟五：為圖片加上一段標題敘述

搜尋引擎在判定圖片的主題內容時，除了從圖片的檔名、圖片的 Alt 標籤還會從圖片附近的內容做為參考，所以在圖片附近加上一段標題敘述，可以讓搜尋引擎更確定圖片的主題性。  
當然為圖片加上一小段標題敘述，有助於搜尋引擎判定圖片主題，建議在圖片標題敘述時應該是自然的，如果過度的使用來堆砌關鍵字，也有可能造成被判定為作弊行為，其中的掌握拿捏是很重要的。  
而html 有一組新標籤元素專門用於圖片以及圖片標題，可提供大家參考  
使用方法如下:

<figure>
<img src="圖片網址" alt="圖片標題"/>
<figcaption>圖片標題敘述文字</figcaption>
</figure>
...
# [網路廣告類型盤點：6大廣告類型、投放建議和重點數據指標](https://imjaylin.com/ads/)
...
•**接觸更多潛在客戶**：不僅可以指定特定國家或地區，更可以針對細分受眾進行投放，並且能以負擔得起的預算進行廣告設定，投放成本通常也比傳統廣告便宜。

•**能夠進行再行銷**：如果許多潛在客戶在沒有購買任何東西的情況下就離開網店，就可以透過再行銷廣告提醒他們，並且提高購買率。

•**可以衡量廣告效益**：傳統廣告通常難以追蹤廣告效益，而網路廣告可以相對有效進行追蹤，網店也可以安裝 Google Analytics 收集數據和分析，可以更精確追蹤網路廣告的投放效益。

### 網路廣告的3大缺點

•**廣告競爭激烈**：廣告競爭程度取決於行業，但是無論如何都必須與對手相互競爭，尤其是對於電子商務企業而言會更明顯，因此各大廣告平台的投放成本已經比早年要高出很多。

•**犯錯是昂貴的**：投放錯誤的受眾、選擇錯誤的關鍵字…等問題都可能會讓廣告預算血本無歸。

要避免這些錯誤，最好先向專家學習或花時間做足事前功課，千萬不要只是傻傻地花錢投放。

•**需要積累經驗**：網路廣告不是花錢投放就好，想要有好的投放效益就需要正確解讀數據和積累優化經驗，這通常是新手相對困擾的層面。

## 台灣6大網路廣告類型

### 1.搜尋廣告

搜尋廣告仍然位居所有網路廣告形式之首，因為多數人們仍然會使用搜尋引擎尋找他們需要的產品和服務，這也是最精準有效的流量來源之一。

目前在台主流搜尋廣告平台有 Google、Bing 和 Yahoo，而 Google 是目前為止市占率最高的搜尋引擎。

![statcounter的台灣搜尋引擎佔比](https://imjaylin.com/wp-content/uploads/2023/05/StatCounter-%E6%90%9C%E5%B0%8B%E5%BC%95%E6%93%8E%E5%8F%B0%E7%81%A3%E5%8D%A0%E6%AF%94-740x417.png)

引用於：[statcounter](https://gs.statcounter.com/search-engine-market-share/all/taiwan/#monthly-202204-202304)

廣告主可以針對特定關鍵字進行投放，而且是按點擊而付費的廣告機制，也是俗稱的的 PPC 廣告或關鍵字廣告。

雖然搜尋廣告是依點擊而付費，然而關鍵字點擊的價格來自廣告主之間的投放競爭程度，這使得不同行業的關鍵字點擊價格落差極大（從幾塊到幾百塊都有）。

另外，搜尋廣告是 SEO 的絕佳搭檔，通過 SEO 可以長期獲取自然搜尋流量，而搜尋廣告可以幫助企業快速獲得立即性結果。

yes123 是一家網路人力銀行，該公司同時採用了搜尋廣告和 SEO，讓用戶在搜尋相關字詞時能夠有更大的能見度。

![Google搜尋引擎](https://imjaylin.com/wp-content/uploads/2023/05/%E6%90%9C%E5%B0%8B%E5%BB%A3%E5%91%8A%E5%92%8CSEO-740x844.png)

購物廣告是另一種新穎的搜尋廣告模式，競爭程度相對比較低，適合販售實體產品的電商品牌進行投放。假如你的同業對手都還沒投放，那麼可以用更划算的成本進行包版，絕對超吸睛。

![Google購物廣告](https://imjaylin.com/wp-content/uploads/2018/08/Google%E8%B3%BC%E7%89%A9%E5%BB%A3%E5%91%8A-740x466.png)

▌延伸閱讀推薦：[Google 關鍵字廣告教學與設定建議](https://imjaylin.com/gads/)

### 2.YouTube 影片廣告

YouTube 是僅次於 Google 搜尋引擎的第二大搜尋引擎，每月活躍用戶超過 20 億，YouTube 廣告早就深入我們的日常生活之中了。

YouTube 廣告是 Google Ads 旗下的廣告類型之一，可以基於人口統計資料、興趣和刊登位置，將影片投放給已經在觀看特定影片或頻道的特定受眾。

最為人熟知的莫過於可略過的串流內廣告，此類 YouTube 廣告會在播放 5 秒後，讓用戶自行決定是否要略過廣告。

![YouTube可略過的串流內廣告](https://imjaylin.com/wp-content/uploads/2023/05/YouTube%E5%8F%AF%E7%95%A5%E9%81%8E%E5%BB%A3%E5%91%8A-740x417.png)

以上畫面截至保力達影片廣告

另外還有不可略過的串流內廣告，這類廣告在於用戶不能選擇略過廣告，用戶必須完整看完影片，非常適合能夠在15 秒內引發人們興趣的產品或服務。

![YouTube不可略過的廣告](https://imjaylin.com/wp-content/uploads/2023/05/YouTube%E4%B8%8D%E5%8F%AF%E7%95%A5%E9%81%8E%E5%BB%A3%E5%91%8A-740x417.png)

無論採用哪一種類型，多數 YouTube 用戶都不樂意看到廣告，因此廣告主應該盡可能在影片前 5 秒提及以下資訊：  
• 品牌名稱  
• 銷售賣點  
• 呼籲行動

因為 YouTube 廣告會打斷用戶觀看影片的過程，如果過於頻繁向同一群用戶投放相同廣告，將會容易產生品牌反感。確保有設定每日/每週觀看頻率上限，最通用的設定是每週觀看不要超過5 次。

![YouTube廣告展示頻率設定](https://imjaylin.com/wp-content/uploads/2023/05/YouTube%E5%BD%B1%E7%89%87%E5%BB%A3%E5%91%8A%E5%B1%95%E7%A4%BA%E9%A0%BB%E7%8E%87%E4%B8%8A%E9%99%90%E8%A8%AD%E5%AE%9A-740x391.png)

### 3.Meta廣告

Meta 擁有兩大社群媒體（Facebook＆Instagram），兩者都是目前最受歡迎的社群平台之一，因此所擁有的受眾條件與數據量非常可觀，這也是 Meta 廣告擁有強大廣告量能的原因。

Meta 廣告可以使用 3 種方式來鎖定受眾：  
•核心受眾  
•自訂受眾  
•類似受眾

其中每一個方式都與 Meta 收集到的用戶數據有關，他們收集用戶的大量數據：他們喜歡什麼、認識誰、去過哪裡、對什麼感興趣，甚至他們在外部網站上做什麼。

Meta 可能不知道用戶需要解決什麼問題，但是他們可以很好地猜測用戶可能對什麼感興趣，然後再向用戶展示高度相關的廣告。

除了掌握受眾鎖定功能之外，Meta 廣告還需要定期更新廣告創意，否則廣告效益將會很難持久。如果不具備美編設計能力，可以借助 Canva 來設計廣告素材。

▌延伸推薦工具：[https://canva.com/](https://partner.canva.com/c/352584/647168/10068)

▌延伸閱讀推薦：[FB廣告投放重點教學＆實操案例](https://imjaylin.com/fail-fbad/)

### 4.LINE廣告

LINE 是台灣市佔率最高的通訊應用工具，而 LAP 成效型廣告是由 LINE 推出的自主廣告投放服務，也就是商家無須透過廣告代理商就能投放 LINE 廣告，門檻也遠比 LINE 保證型廣告要低得多。

LAP 廣告的操作模式非常類似 Meta 廣告，同樣可以基於用戶興趣、自訂受眾和類似受眾…等條件進行投放，就連廣告後台介面都有高度雷同，不過目前的投放成本比 Meta 廣告還要低。

![LINE廣告投放後台](https://imjaylin.com/wp-content/uploads/2023/05/LINE%E6%88%90%E6%95%88%E5%9E%8B%E5%BB%A3%E5%91%8A-740x515.png)

LAP 廣告的最大優勢之處是可以無縫結合 LINE 官方帳號，所以除了可以用來開發新客之外，對於本來就有在經營 LINE 官方帳號的商家而言特別適合。

▌延伸閱讀推薦：[【LINE廣告投放教學】掌握LAP廣告投放技巧](https://imjaylin.com/lap/)

### 5.展示型廣告

展示型廣告（Display Advertising）又被稱為橫幅廣告，因為早在 1994 出現的時候就是一張橫幅圖片。

![AT&T 橫幅廣告](https://imjaylin.com/wp-content/uploads/2023/05/ATT%E6%A9%AB%E5%B9%85%E5%BB%A3%E5%91%8A.jpg)

隨著網頁設計變得完善和成熟，展示型廣告演變為各種形狀和尺寸，後來廣告內容可以包含圖片、文字與影片，甚至能有互動元素和彈出視窗的形式。

展示型廣告的點擊率通常很低，在所有格式和平台上平均統計只有 0.05%，而且銷售轉換率也不高。然而，展示型廣告依然會對品牌知名度和購買意願產生影響。

展示型廣告可以通過 Meta 廣告或 Google 廣告…等平台進行投放，可以藉由這些平台將廣告投遞到合作夥伴網站上，觸及全球數百萬網站上的用戶。

也可以直接跟各大媒體網站直接購買廣告版位，只是通常投放單價不低。

對於再行銷廣告應用，展示型廣告特別能發揮作用，因為它們能夠充分提醒離開網站的用戶，讓廣告顯得無所不在，因而提高投資回報率。

▌延伸閱讀推薦：[什麼是再行銷廣告？](https://imjaylin.com/%e5%86%8d%e8%a1%8c%e9%8a%b7%e5%bb%a3%e5%91%8a/)

### 6.零售媒體聯播網

零售媒體聯播往又稱 RMN，來自RETAIL MEDIA NETWORK 的英文縮寫，顧名思義是零售商發展或經營的廣告聯播網。零售電商平台上的廣告，或實體零售店的APP 和店內看板都屬於此範疇。

舉凡 Amazon、Walmart、Ebay、UberEats、Pinkoi、家樂福、全家、momo、蝦皮…等都屬於零售媒體廣告平台的代表。

零售媒體廣告仍然相對較新，但隨著技術成熟，以及第三方 cookie 退場後，它將會變成更加有用的網路廣告形式。

RMN 的優勢是使用平台第一方數據 ，可以有效進行廣告定位和成效歸因，投資報酬率自然更好。因為平台用戶本身就有高度購物意圖或意向，所以廣告主容易接觸到相關消費者。

例如我是 momo 賣家，就可以透過 momo Ads 投放站內搜尋廣告，並且鎖定特定字詞投放曝光商品。讓正在搜尋＂客廳地毯＂的 momo 會員能夠快速看到自家的地毯商品。

![momo站內廣告形式](https://imjaylin.com/wp-content/uploads/2024/06/momo%E5%BB%A3%E5%91%8A%E5%BD%A2%E5%BC%8F-740x256.jpg)

也可以藉由投放展示型廣告，並且依據品類、興趣或消費者族群鎖定特定受眾，可以非常容易接觸到正在 momo 平台上尋找特定商品或種類的目標客群。

![momo展示廣告受眾類型](https://imjaylin.com/wp-content/uploads/2024/06/momo%E5%BB%A3%E5%91%8A%E5%8F%97%E7%9C%BE%E9%A1%9E%E5%9E%8B-740x301.jpg)

雖然 RMN 廣告投放成本遠比 Google Ads 和 Meta 廣告來得便宜，購買轉換率也來得更高，不過必須得先成為零售平台商的客戶。這對於某些品牌方而言，無疑立下一道投放門檻了。

## 網路廣告投放建議

任何廣告策略的目標都應該是獲得正向的投資回報，這取決於從廣告活動中獲得的收入是否高於投入的成本。

然而，要獲得更好的投資報酬率有以下 5 個投放重點：

•**掌握目標受眾**：目標受眾可能會有不同的群體，不同群體通常有一些共同點，比如年齡、性別、地點、興趣…。

接下來是為目標受眾量身訂製合適的商品與內容，如果銷售的是服飾，請確保為女性受眾量身定制的廣告內容與男性受眾有所不同。

•**選擇廣告平台**：在選擇廣告渠道時，最好的辦法是定義目標受眾是誰。例如不同年紀，慣用的渠道或平台也會不盡相同，因此了解受眾的習慣和平台特性才能做出正確的選擇。

•**吸睛廣告創意**：網路廣告需要能夠吸引用戶的注意力，所以要讓廣告富有表現力和相關性。因此需要熟悉每種廣告格式，並且搭配合宜的視覺素材和多加測試。

另一個重點是撰寫有吸引力的文案，除了要清晰表達好處與特點之外，可以嘗試在文案中使用數字或數據，也可以在廣告標題中包含關鍵字（尤其是搜尋廣告），這通常會增加點擊率。

社群廣告則是可以善加使用表情符號，這也是讓文案更具吸引力的小技巧。

•**網頁體驗優化**：多數消費者都是通過手機上網的，網站如果不能充分迎合手機上網體驗，這將會讓廣告效益大打折扣。

•**數據分析與優化**：通過數據分析可以了解廣告是否有帶來正向回報，進而決定要繼續投放、暫停或加碼預算。

## 一定要知道的廣告數據指標

了解廣告數據指標是了解網路廣告表現的關鍵，這可以幫助用來優化廣告策略，控制成本並提高廣告效益。
...
•**點擊率 (CTR)** ：用戶看到廣告並點擊廣告的次數百分比。

•**轉換率**：通過點擊廣告並完成特定轉換行為的百分比。

•**每千次曝光成本 (CPM)** ：每千次廣告曝光的平均成本。

•**每次點擊費用 (CPC)** ：獲得一次廣告點擊所需支付的平均成本。

•**每次轉換成本 (CPA)** ：從廣告獲得轉換的平均成本。

•**ROAS**：ROAS 是 Return on Advertising Spend 的縮寫，中文翻譯是廣告投資回報率，它是用來衡量廣告支出所帶來的投資回報率。

## 網路廣告常見問題

### 為什麼要投放網路廣告？

企業會出於各種原因而投放網路廣告，包括：提高品牌知名度、提高產品銷量、推動回購…等原因。相比其他網路行銷策略，網路廣告可以用更短的時間提高銷售效益。

### 網路廣告有哪些類型？

網路廣告的常見形式包括展示型廣告、搜尋廣告、社群廣告、原生廣告、影音廣告，這幾種類型都能在各大廣告平台中看到身影。

### 網路廣告需要花多少錢？

網路廣告投放成本不盡相同，會因為不同的廣告平台、廣告類型、出價策略而有所差異。不過，企業可以自行決定要在網路廣告上花費多少，這一點比傳統廣告要彈性得多。

所以即使預算有限，小商家依舊能透過網路廣告擴大曝光範圍。可以一併參考這篇文章：[網路廣告預算怎麼抓？](https://imjaylin.com/ad-budget/)

### 廣告要花多少錢才有用？

撇除個人的有用定義和預期，其實小預算也能達成有效的推廣成果！相比要花多少錢，更重要的是如何善用有限預算。強烈建議先小額投放測試，有效之後再放大擴量！

可怕的並不是廣告預算太少，而是預算不多卻想要達成龐大的銷售業績，不合理的期待再大預算都無法實現的。

### 哪個廣告平台最有效？

大多數品牌方會優先選擇 Google 和 Meta，不過這不是標準答案。只是因為他們擁有龐大的流量、提供良好的投放精準度，以及有非常完善的廣告功能，同時也符合多數產業。

例如 B2B 企業就需要重視 Linkedin 廣告；針對年輕族群可以額外嘗試 TikTok 廣告或小紅書廣告。所以哪個廣告平台更有成效，跟產業和目標受眾有極大關連。

###### 最後我想說的是…

然而出於某種原因，一些守舊的商家仍然避免花錢投放網路廣告。不過網路廣告真的非常有助於銷售出更多產品，只要使用得當，網路廣告是商家發展與提升銷售業績的加速器。

目前網路廣告類型與格式非常多樣，幾乎可以滿足各種產業和需求。不同的網路廣告都可以單獨測試，了解各平台的轉換率和投資報酬率之後，再明智地分配預算。

強烈建議一定要多方測試，不要因為一次小小的挫敗就徹底放棄網路廣告行銷策略。

總體而言，網路廣告的競爭程度已經比早年高出非常多，但是它依然具有非常大的影響力，未來一定也會繼續成為主要的[數位行銷策略](https://imjaylin.com/digital/)之一。





# [數位廣告的五種常見類型一次搞懂！為什麼要下網路廣告 ？｜鵠崙設計](https://www.design-hu.com/web-news/type-of-digital-advertising.html)
...
**國外知名市場研究機構Strategy Analytics指出， 數位廣告 已經成為新常態，它是增長最快的行銷管道。**且根據國外市場研究公司eMarketer指出，2020年美國社群媒體廣告支出達到430億美元，比2019年增長了20%。現在消費者接收資訊的管道已經漸漸從線下轉換到線上，而在這樣轉換的同時，品牌所要實行的行銷策略，以及要投放的廣告，都勢必須要改變支出行銷預算的比例。

之前的內容「[數位廣告是什麼？跟傳統廣告有什麼區別？告訴你該使用哪種！](https://www.design-hu.com/web-news/digital-advertising-vs-traditional-advertising.html)」中有提及 數位廣告 的概念以及與傳統廣告間的區別，其中有提到兩者之間最大的不同在於準確性與靈活度。除此之外，**數位廣告 還能降低行銷成本，之前我們也提過，數位廣告具有針對性，品牌可以利用社群媒體的特性，根據年齡、性別、位置、興趣等相關變量，只向特定受眾投放廣告內容。**或是品牌可以對搜尋品牌相關產品與服務的特定關鍵字下廣告，這樣只有對這些關鍵字有興趣的用戶會接觸到推廣訊息。

**數位廣告 通常也比傳統廣告更具成本效益，通過相關的機制，依據點擊次數、觀看時長等來決定廣告的費用**，所以能使品牌定期衡量支出的預算並隨時進行調整。也因此數位行銷可以利用較少的預算幫助我們接觸到更多的受眾，並且瞄準最有可能購買品牌產品或服務的潛在客戶。

而且 數位廣告 可以使品牌隨時隨地都接觸到受眾，無論這些受眾身在何處，只要他們使用網路就可以透過線上管道接觸到他們**。**尤其現今的手機普及率相當高，幾乎是人手一機，根據國外公司adroll的報告《Facebook by the Numbers》中指出手機等的移動裝置上關於Facebook某個版位的廣告點擊率，通常比桌面設備高10%，並且每次點擊成本比桌面設備低61%。雖然這是只針對Facebook的數據，但是我們能從中看出手機等移動裝置對於行銷人做推廣的重要性。且根據美國網路廣告組織(IAB)的一項研究指出，手機用戶有近一半會因為在手機上看到相關廣告而採取行動。

**根據國外數據公司Statista指出， 數位廣告 使用網際網路以各種格式向用戶傳遞行銷訊息，包括搜尋引擎廣告、社群媒體廣告、影片廣告等，在2021年的全球 數位廣告 支出為4655億美元，預計到了2026年會增長到6831億美元。**在下一段將會分享幾種常見的 數位廣告 類型。

![數位廣告的五種常見類型一次搞懂！為什麼要下網路廣告 ？｜網頁新知｜鵠崙設計02](https://i0.wp.com/www.design-hu.com/wp-content/uploads/%E6%95%B8%E4%BD%8D%E5%BB%A3%E5%91%8A%E7%9A%84%E4%BA%94%E7%A8%AE%E5%B8%B8%E8%A6%8B%E9%A1%9E%E5%9E%8B%E4%B8%80%E6%AC%A1%E6%90%9E%E6%87%82%EF%BC%81%E7%82%BA%E4%BB%80%E9%BA%BC%E8%A6%81%E4%B8%8B%E7%B6%B2%E8%B7%AF%E5%BB%A3%E5%91%8A-%EF%BC%9F%EF%BD%9C%E7%B6%B2%E9%A0%81%E6%96%B0%E7%9F%A5%EF%BD%9C%E9%B5%A0%E5%B4%99%E8%A8%AD%E8%A8%8802.png)

## 二、 數位廣告 有哪些常見類型？

數位廣告 的類型其實有相當多種，本文主要是要介紹五種最常見的廣告類型：**搜尋引擎行銷、展示型廣告、社群媒體廣告、影片廣告與電子郵件行銷。**

### 1.搜尋引擎行銷（SEM）​

SEM是Search Engine Marketing的縮寫，也就是在包括Google和Bing這種搜尋引擎上的帶「廣告」標籤的搜尋內容。我們不能否認的是，**通常我們進行關鍵字查詢的時候，就算有再多的內容，大部分的用戶幾乎只看第一頁的搜尋結果**，這時SEM就顯得相當重要，它能使品牌的網站、內容一定會顯示在搜尋的前幾頁結果內。根據美國網路廣告組織(IAB)的數據指出，搜尋引擎這種廣告方式，廣告的支出自2019年以來增加了7.8%，佔整體 數位廣告 總收入的42.2%。

當然，透過不斷撰寫文章進行內容行銷，達到優化SEO的效果固然是最好的，但是這樣的方法是長期耗費時間長的，當品牌剛起步完全沒有任何知名度的時候，通過SEM來達到一定程度的曝光對於品牌來說是有效的，**根據國外公司SEO Tribunal於2019年指出，付費搜尋廣告可以將品牌知名度提高80%。**

![數位廣告的五種常見類型一次搞懂！為什麼要下網路廣告 ？｜網頁新知｜鵠崙設計03](https://i0.wp.com/www.design-hu.com/wp-content/uploads/%E6%95%B8%E4%BD%8D%E5%BB%A3%E5%91%8A%E7%9A%84%E4%BA%94%E7%A8%AE%E5%B8%B8%E8%A6%8B%E9%A1%9E%E5%9E%8B%E4%B8%80%E6%AC%A1%E6%90%9E%E6%87%82%EF%BC%81%E7%82%BA%E4%BB%80%E9%BA%BC%E8%A6%81%E4%B8%8B%E7%B6%B2%E8%B7%AF%E5%BB%A3%E5%91%8A-%EF%BC%9F%EF%BD%9C%E7%B6%B2%E9%A0%81%E6%96%B0%E7%9F%A5%EF%BD%9C%E9%B5%A0%E5%B4%99%E8%A8%AD%E8%A8%8803.png)

### 2.展示型廣告（Display Advertising）

展示型廣告比較接近傳統廣告的呈現形式，主要是利用展式圖像以及文字來吸引用戶的注意力，最常見的方法是在網站中以廣告橫幅、登陸頁面、彈出窗口等形式出現，通常會使用在特定於品牌受眾會觀看的內容、使用的網站上。例如，販賣體育相關用品，體育新聞就是展示廣告的好地方。**國外有篇報告《The Digital Brand Effect》調查顯示，線上的展示型廣告被發現可以創造有意義的品牌差異並建立品牌聯想。**

![數位廣告的五種常見類型一次搞懂！為什麼要下網路廣告 ？｜網頁新知｜鵠崙設計04](https://i0.wp.com/www.design-hu.com/wp-content/uploads/%E6%95%B8%E4%BD%8D%E5%BB%A3%E5%91%8A%E7%9A%84%E4%BA%94%E7%A8%AE%E5%B8%B8%E8%A6%8B%E9%A1%9E%E5%9E%8B%E4%B8%80%E6%AC%A1%E6%90%9E%E6%87%82%EF%BC%81%E7%82%BA%E4%BB%80%E9%BA%BC%E8%A6%81%E4%B8%8B%E7%B6%B2%E8%B7%AF%E5%BB%A3%E5%91%8A-%EF%BC%9F%EF%BD%9C%E7%B6%B2%E9%A0%81%E6%96%B0%E7%9F%A5%EF%BD%9C%E9%B5%A0%E5%B4%99%E8%A8%AD%E8%A8%8804.png)

### 3.社群媒體廣告（Social Media Advertising）​

**根據國外數據公司Statista所提供的數據指出， Facebook 目前每月活躍用戶超過28.9億**，而且Facebook目前還擁有四個最大的社群媒體平台，每個平台的月活躍用戶均超過10億：Facebook、WhatsApp、Facebook Messenger 和 Instagram。這個數據顯示在社群媒體上投放 數位廣告 有多重要，這些活躍的用戶數都將成為品牌的潛在受眾。

而且**根據Business Insider在2020年的報導顯示，在美國，Facebook的廣告支出超過310億美元。**另外根據美國網路廣告組織(IAB)研究指出，社群媒體佔所有網際網路廣告收入的29.6%，2020年收入還快速增加到415億美元。而通常在Facebook上看到顯示「贊助」二字的就是社群媒體廣告，社群媒體廣告還有一個特點就是，如果透過廣告所觸及的受眾將我們所投廣的內容進行分享的話，這些曝光是不會增加廣告費用的，所以**在下廣告的同時，要注意這篇貼文是否有效引起用戶注意，甚至使用戶願意轉發。**

![數位廣告的五種常見類型一次搞懂！為什麼要下網路廣告 ？｜網頁新知｜鵠崙設計05](https://i0.wp.com/www.design-hu.com/wp-content/uploads/%E6%95%B8%E4%BD%8D%E5%BB%A3%E5%91%8A%E7%9A%84%E4%BA%94%E7%A8%AE%E5%B8%B8%E8%A6%8B%E9%A1%9E%E5%9E%8B%E4%B8%80%E6%AC%A1%E6%90%9E%E6%87%82%EF%BC%81%E7%82%BA%E4%BB%80%E9%BA%BC%E8%A6%81%E4%B8%8B%E7%B6%B2%E8%B7%AF%E5%BB%A3%E5%91%8A-%EF%BC%9F%EF%BD%9C%E7%B6%B2%E9%A0%81%E6%96%B0%E7%9F%A5%EF%BD%9C%E9%B5%A0%E5%B4%99%E8%A8%AD%E8%A8%8805.png)

### 4.影片廣告（Video Advertising）

影片是將某種宣傳服務內容或產品的影片，放在像是 YouTube、Facebook 上，在其他影片內容之前所顯示的商業廣告內容，那也因為在這些管道上投放的影片廣告是可以跳過的，所以用戶提供的注意力時間非常短暫，非常考驗製作影片廣告內容行銷人的創意，影片廣告被證明是有效能使用戶接收更多品牌相關內容的，**根據國外公司SEO Tribunal於2019年指出，43%的新客戶在看到 YouTube 廣告中的產品後首次購買。** 而製作影片廣告時，必須要注意並確保影片在沒有聲音的情況下，仍然可以吸引用戶且富有意義。怎麼說呢？**因為在很多情況下，用戶可能會因為觀看廣告的時間和地點上的限制而無法收聽聲音，所以在影片廣告中的聲音上，許多廣告商會使用與影片契合的背景音樂，而不是相關的資訊內容。**

![數位廣告的五種常見類型一次搞懂！為什麼要下網路廣告 ？｜網頁新知｜鵠崙設計06](https://i0.wp.com/www.design-hu.com/wp-content/uploads/%E6%95%B8%E4%BD%8D%E5%BB%A3%E5%91%8A%E7%9A%84%E4%BA%94%E7%A8%AE%E5%B8%B8%E8%A6%8B%E9%A1%9E%E5%9E%8B%E4%B8%80%E6%AC%A1%E6%90%9E%E6%87%82%EF%BC%81%E7%82%BA%E4%BB%80%E9%BA%BC%E8%A6%81%E4%B8%8B%E7%B6%B2%E8%B7%AF%E5%BB%A3%E5%91%8A-%EF%BC%9F%EF%BD%9C%E7%B6%B2%E9%A0%81%E6%96%B0%E7%9F%A5%EF%BD%9C%E9%B5%A0%E5%B4%99%E8%A8%AD%E8%A8%8806.png)

### 5.電子郵件行銷（Email Marketing）

有人可能會疑惑電子郵件廣告還有人在看嗎？根據國外數據公司Statista指出，Email這個管道的使用量以每年2%～3%的速度增長，表示使用人數是不斷往上增加的。且**根據The Data & Marketing Association於2018發表的研究表明，有99%的消費者每天都會查看他們的電子信箱。**

而電子郵件行銷，就是透過Email將品牌的相關資訊，可能是產品、服務或是促銷等的訊息發送給之前給過品牌個人信箱的用戶，這些用戶可能是本身有在使用品牌服務、產品的人，也有可能只是對品牌有興趣的潛在用戶，**長期的透過發訊息給用戶，加深用戶對於品牌的理解度，將能慢慢建立用戶對於品牌的忠誠度與信賴度，**增加與顧客間的聯繫，且根據國外數據公司Statista於2021年提供的數據顯示，2020年全球電子郵件行銷市場價值75億美元，預計到2027年將增加至179億美元，另外再**根據國外公司HubSpot所提供的報告顯示，在電子郵件上花費1美元的廣告就能產生42美元的效益，投資回報率達到4,200%** 

![數位廣告的五種常見類型一次搞懂！為什麼要下網路廣告 ？｜網頁新知｜鵠崙設計07](https://i0.wp.com/www.design-hu.com/wp-content/uploads/%E6%95%B8%E4%BD%8D%E5%BB%A3%E5%91%8A%E7%9A%84%E4%BA%94%E7%A8%AE%E5%B8%B8%E8%A6%8B%E9%A1%9E%E5%9E%8B%E4%B8%80%E6%AC%A1%E6%90%9E%E6%87%82%EF%BC%81%E7%82%BA%E4%BB%80%E9%BA%BC%E8%A6%81%E4%B8%8B%E7%B6%B2%E8%B7%AF%E5%BB%A3%E5%91%8A-%EF%BC%9F%EF%BD%9C%E7%B6%B2%E9%A0%81%E6%96%B0%E7%9F%A5%EF%BD%9C%E9%B5%A0%E5%B4%99%E8%A8%AD%E8%A8%8807.png)

## 三、結語

這些不同類型的 網路廣告 因為都擁有各自的特性，因此在平時的使用上是可以做為互補使用的，例如，社群媒體廣告和展示型廣告可以同時出現在 Facebook上，但用戶會以不同的方式看到它們，總體而言，品牌還是要以目標受眾的特質與興趣做為投放廣告判斷的依據。

> 
> 
> 
> 
> ![](https://i0.wp.com/www.design-hu.com/wp-content/uploads/%E6%95%B8%E4%BD%8D%E5%BB%A3%E5%91%8A%E7%9A%84%E4%BA%94%E7%A8%AE%E5%B8%B8%E8%A6%8B%E9%A1%9E%E5%9E%8B%E4%B8%80%E6%AC%A1%E6%90%9E%E6%87%82%EF%BC%81%E7%82%BA%E4%BB%80%E9%BA%BC%E8%A6%81%E4%B8%8B%E7%B6%B2%E8%B7%AF%E5%BB%A3%E5%91%8A-%EF%BC%9F-%E5%A4%A7.jpeg)
...
# [數位廣告到底有哪些？又該如何選擇？ 我們｜GTUT久大寰宇科技](https://www.gtut.com.tw/news-service-page182)
...
數位行銷是近年來快速崛起的行銷領域，而數位廣告就是其中一個不可忽視的部分，就像以往企業品牌在電視、報紙、戶外廣告看板購買投放廣告一樣，當行銷數位化之後，廣告也轉移為數位的形式持續發展。

而數位廣告因應不同客群的網路使用習慣，漸漸出現了許多不同的種類與投放平台，導致剛開始做數位行銷的企業經常無從下手，然而在這個數位化的時代裡，找到合適的廣告方式進行品牌曝光，是數位行銷的致勝關鍵之一，可以說是不可錯失的良機。

要知道選擇哪種廣告類型才適合自己的企業和品牌，就要先了解各種數位廣告的屬性與優勢，我們整理出了目前常見的八大數位廣告類型，一一進行介紹：

 

#### 展示型廣告（Display Ads）

展示型廣告可以說是普遍最熟悉的數位廣告類型之一，利用圖像、影音和文字，在網頁畫面上的廣告區域出現，由於展示型廣告容易吸引網頁使用者的目光，因此適合用於**建立品牌意識及形象、展示優惠活動**等。

展示型廣告也可以根據使用者的行為軌跡、瀏覽紀錄等資料，進行更精準的投放，且根據[Digital Information World](https://www.digitalinformationworld.com/2014/09/infographic-retargeting-advertising-statistics.html)的分析，展示型廣告搭配**[再行銷](https://www.gtut.com.tw/news-service-page182#some-section-id)**的手法，轉換率更接近70%，可以說是相當有效的數位廣告形式。  
 

#### 原生廣告（Native Ads）

瀏覽網頁或社群時，會看到文章或頁面連結出現「你可能感興趣……」、「延伸閱讀」等字樣，將廣告以和網頁內容相同的形式展出，就是**原生廣告**。原生廣告不像展示型廣告顯眼，不過由於更融入網站頁面，容易讓使用者卸下心防而按下廣告連結。  
 

#### 影音廣告（Video Ads）

影音廣告可以說是近年來相當興盛的一種廣告類型，和傳統電視廣告概念相同，透過影片素材將資訊傳遞給閱聽者，由於年輕一代對影音平台的依賴度提升，影音廣告的效益也有所提升。

雖然和其他廣告方式比較起來，製作影片的前期成本比較高，但由於網路影音平台的投放成本比傳統電視要低得多，且近年來閱聽者對優質的故事行銷類影片廣告有更高的接受度，加上影音廣告可以在播放的同時提供連結，增加與使用者即時的互動，因此優秀的影音廣告可以帶來的效益也不可小覷。  
 

#### 關鍵字廣告（PPC, Pay Per Click）

當我們使用搜尋引擎時，搜尋結果的前幾項通常會標示著「廣告」，這些就是**關鍵字廣告**。關鍵字廣告屬於SEM（Search Engine Marketing）的一環，又被稱作PPC廣告（Pay Per Click點擊付費），透過購買關鍵字，讓使用者在搜尋時看見廣告的頁面連結，而只有當使用者點擊廣告連結時，廣告商才需要付費。

由於搜尋關鍵字是使用者主動的行為，通常是潛在消費者的比例也更高，關鍵字廣告可以更精準地將資訊送到這些使用者眼前，可以說是**提升流量、發掘潛在消費者**的有效管道。而同屬SEM的SEO搜尋引擎優化同樣也能帶來流量，關鍵字廣告與SEO可以說是相輔相成的行銷方式，若能雙管齊下，當然能帶來更好的行銷效益。（延伸參考：[數位廣告投放跟SEO網站優化到底差在那](https://www.gtut.com.tw/news-service-page178)）  
 

#### 購物廣告（Shopping Ads）

購物廣告和關鍵字廣告類似，都是在使用者搜尋關鍵字時，會將設定的廣告內容與連結顯示在頁面上，不過購物廣告會直接以商品的模式呈現，包括圖片、名稱、價格等，使用者可以在搜尋結果的畫面上直接比較商品，因此以購物廣告來說，商品本身的競爭力會直接影響廣告成效。  
 

#### 社群廣告（Social Media）

根據[We Are Social和Hootsuite](https://wearesocial.com/uk/blog/2021/01/digital-2021-uk/)聯合發表的數據顯示，在2021年初，全球社群媒體的使用者人數已經突破42億，平均每個人更是每天都要花近兩個半小時的時間在社群媒體上，這個數據還持續在增長當中，因此社群廣告可以說是有著相當高的效益。

目前最大的社群平台還是以Facebook為主，其次有Instagram、Twitter等，社群廣告可以根據社群使用者的行為軌跡、興趣喜好等進行調整，提升投放的精準度，並且有貼文、圖片、影音、即時通訊等多樣化的模式。社群廣告還可以提供連結到社群的官方帳號，讓潛在消費者有更大的機會持續關注品牌資訊。  
 

#### 再行銷（Retargeting）

再行銷廣告是利用cookie記錄使用者的瀏覽歷史，並在之後根據紀錄投放廣告到使用者眼前，例如瀏覽過某運動用品網站，之後其他網站的廣告便變成該網站的廣告。再行銷廣告透過再次將網站或商品資訊推送到使用者眼前，喚起使用者的印象及興趣，能夠增加消費者的轉換率。  
 

#### 聯盟行銷（Affiliate Marketing）

聯盟行銷是廣告商和如部落客、網紅、KOL等進行合作，藉由第三方的推廣，達到廣告的效果，近年來由於人們對網路使用習慣的改變，使得這樣的網紅行銷、業配等聯盟行銷的模式變得更加盛行。  
 

##### 如何選擇適合的數位廣告類型？

沒有那一種數位廣告是最好的，每一種廣告都有不同的TA族群（Target audience目標受眾），且根據需要投入的資源和成本，不同的品牌企業所適合使用的廣告形式也不盡相同，在選擇廣告平台之前，可以先思考自己的TA族群是哪些人、經常使用哪種類型的平台，以及自己的廣告預算等，透過初步的篩選來決定使用的廣告類型。
